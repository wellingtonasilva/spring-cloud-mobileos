...
CREATE TABLE mos_checklist (
    ...
    chkl_dtmovimento          TIMESTAMP WITH LOCAL TIME ZONE,
    chkl_dstipoveiculo        VARCHAR2(60),
    chkl_nnmatricula          INTEGER,
    chkl_nmcondutor           VARCHAR2(60),
    chkl_nmsetor              VARCHAR2(60),
    chkl_dtsaida              TIMESTAMP WITH LOCAL TIME ZONE,
    chkl_nnkmsaida            FLOAT,
    chkl_dtretorno            TIMESTAMP WITH LOCAL TIME ZONE,
    chkl_nnkmretorno          FLOAT,
    chkl_nnplacaveiculo       VARCHAR2(20),
    chkl_icfinalizousaida     SMALLINT,
    chkl_icfinalizouretorno   SMALLINT,
    chkl_nncnh                VARCHAR2(20),
...
CREATE TABLE mos_checklist_grupo (
    ...
    chgr_dschecklistgrupo   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_checklist_item (
    ...
    chgr_id                INTEGER NOT NULL,
    chit_dschecklistitem   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_checklist_item_opcao (
    ...
    chit_id                     INTEGER NOT NULL,
    chio_dschecklistitemopcao   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_checklist_resposta (
    ...
    chre_dtmovimento        TIMESTAMP WITH LOCAL TIME ZONE,
    chre_nnplacaveiculo     VARCHAR2(20),
    chre_tmsaida            TIMESTAMP WITH LOCAL TIME ZONE,
    chre_tmretorno          VARCHAR2 
...
CREATE TABLE mos_empresa (
    empr_id              INTEGER NOT NULL,
    empr_nmrazaosocial   VARCHAR2(60),
    empr_nmfantasia      VARCHAR2(60),
    empr_dsendereco      VARCHAR2(60),
    empr_dscomplemento   VARCHAR2(60),
    empr_nmbairro        VARCHAR2(30),
    empr_nmcidade        VARCHAR2(30),
    empr_coduf           VARCHAR2(2),
    empr_codcep          VARCHAR2(11),
    empr_nncnpj          VARCHAR2(20),
    empr_nntelefone      VARCHAR2(20),
    empr_dsemail         VARCHAR2(100)
)
LOGGING;
...
CREATE TABLE mos_equipe (
    ...
    empr_id                     INTEGER NOT NULL,
    eqpe_nmequipe               VARCHAR2(60),
    eqpe_nnplacaveiculo         VARCHAR2(20),
...
CREATE TABLE mos_funcionario (
    ...
    func_nmfuncionario   VARCHAR2(60),
    func_nncnh           VARCHAR2(20)
)
LOGGING;
...
CREATE TABLE mos_hidrometro_local_armaz (
    ...
    empr_id                   INTEGER NOT NULL,
    hdla_dslocalarmazenagem   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_hidrometro_local_inst (
    ...
    empr_id                  INTEGER NOT NULL,
    hloi_dslocalinstalacao   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_hidrometro_situacao (
    ...
    empr_id                 INTEGER NOT NULL,
    hdst_dstiposituacaohm   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_hidrometro_tipo_instal (
    ...
    empr_id                   INTEGER NOT NULL,
    htpi_dstipoinstalacaohm   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_hidrometro_tipo_subs (
    ...
    empr_id                   INTEGER NOT NULL,
    hits_dstiposubstituicao   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_imovel (
    ...
    imov_nninscricao             VARCHAR2(30),
    imov_nmclienteresponsavel    VARCHAR2(60),
    imov_nmclienteusuario        VARCHAR2(60),
    imov_nmclienteproprietario   VARCHAR2(60),
    ...
    imov_dtligacao               TIMESTAMP WITH LOCAL TIME ZONE,
    imov_nnhidrometro            VARCHAR2(20),
    imov_dtinstalacaohm          TIMESTAMP WITH LOCAL TIME ZONE
)
LOGGING;
...
CREATE TABLE mos_interrupcao (
    ...
    empr_id                    INTEGER NOT NULL,
    eqpe_id                    INTEGER NOT NULL,
    inte_dtmovimento           TIMESTAMP WITH LOCAL TIME ZONE,
    inte_nmequipe              VARCHAR2(60),
    inte_nnmatricula           INTEGER,
    inte_nnos                  INTEGER,
    inte_dsinterrupcaomotivo   VARCHAR2(60),
    inte_dsobervacaoinicio     VARCHAR2(400),
    inte_dsobervacaofim        VARCHAR2(400),
    inte_dtinicio              DATE,
    inte_hrinicio              VARCHAR2(10),
    inte_dtfim                 DATE,
    inte_hrfim                 VARCHAR2(10),
...
CREATE TABLE mos_interrupcao_motivo (
    inmo_id                    INTEGER NOT NULL,
    empr_id                    INTEGER NOT NULL,
    inmo_dsinterrupcaomotivo   VARCHAR2(60),
    inmo_dsabreviado           VARCHAR2(5),
...
CREATE TABLE mos_ligacao_agua_situacao (
    lags_id                      INTEGER NOT NULL,
    empr_id                      INTEGER NOT NULL,
    lags_dsligacaosituacaoagua   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_ligacao_esgoto_situacao (
    legs_id                        INTEGER NOT NULL,
    empr_id                        INTEGER NOT NULL,
    legs_dsligacaoesgotosituacao   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_local_ocorrencia (
    ...
    empr_id                  INTEGER NOT NULL,
    loco_dslocalocorrencia   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_material (
    ...
    empr_id           INTEGER NOT NULL,
    mate_dsmaterial   VARCHAR2(60),
    unid_id           INTEGER NOT NULL,
    mate_dsunidade    VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_motivo_corte (
    ...
    empr_id              INTEGER NOT NULL,
    mcor_dsmotivocorte   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_motivo_encerramento (
    ...
    mote_dsmotivoencerramento   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_ordem_servico (
    ...
    orse_dssituacao               VARCHAR2(25),
    orse_tmgeracao                TIMESTAMP WITH LOCAL TIME ZONE,
    orse_dsobservacao             VARCHAR2(400),
    rgat_id                       INTEGER,
    rgat_cdsituacao               INTEGER,
    rgat_dssituacao               VARCHAR2(25),
    rgat_tmregistroatendimento    TIMESTAMP WITH LOCAL TIME ZONE,
    rgat_dsobservacao             VARCHAR2(400),
    svtp_id                       INTEGER NOT NULL,
    logr_nmlogradouro             VARCHAR2(60),
    bair_nmbairro                 VARCHAR2(60),
    rgat_nnimovel                 VARCHAR2(20),
    clie_id                       INTEGER,
    imov_id                       INTEGER,
    clie_nmcliente                VARCHAR2(60),
    svtp_idexecutado              INTEGER NOT NULL,
    orse_tmencerramento           TIMESTAMP WITH LOCAL TIME ZONE,
    mote_id                       INTEGER NOT NULL,
    orse_dsparecerencerramento    VARCHAR2(400),
    orse_dtexecucao               NUMBER,
    orse_tmexecucao_inicio        VARCHAR2(10),
    orse_tmexecucao_fim           VARCHAR2(10),
    eqpe_idexecucao               INTEGER NOT NULL,
    orse_nnprofunidaderede        VARCHAR2(25),
    orse_nnpressaorede            VARCHAR2(25),
    orse_tmcancelamento           TIMESTAMP WITH LOCAL TIME ZONE,
    svtp_idgerar                  INTEGER NOT NULL,
    orse_nnkminicial              INTEGER,
    orse_nnkmfinal                INTEGER,
    orse_dtprogramacao            TIMESTAMP WITH LOCAL TIME ZONE,
    eqpe_idprogramada             INTEGER NOT NULL,
    hidr_nnanofabricacao          INTERVAL DAY(9) TO SECOND(0),
    hidr_nnhidrometro             VARCHAR2(20),
    rgat_dscomplementoendereco    VARCHAR2(60),
    hidi_dtinstalacaohidrometro   TIMESTAMP WITH LOCAL TIME ZONE,
    hidi_nnselo                   VARCHAR2(20),
    imov_nnlote                   INTEGER,
    qdra_nnquadra                 VARCHAR2(10),
...
CREATE TABLE mos_ordem_servico_corte (
    ...
    cotp_id               INTEGER NOT NULL,
    func_id               INTEGER NOT NULL,
    osco_dtcorte          TIMESTAMP WITH LOCAL TIME ZONE,
    osco_tmcorte          VARCHAR2(10),
    osco_nnleituracorte   INTEGER,
    osco_nnselocorte      VARCHAR2(20)
)
LOGGING;
...
CREATE TABLE mos_ordem_servico_foto (
    ...
    orse_id            INTEGER NOT NULL,
    osft_nmfoto        VARCHAR2(60),
    osft_dsfoto        VARCHAR2(60),
    osft_nnlatitude    VARCHAR2(25),
    osft_nnlongitude   VARCHAR2(25),
    osft_dtfoto        TIMESTAMP WITH LOCAL TIME ZONE,
...
CREATE TABLE mos_ordem_servico_insthm (
    ...
    hpro_id                    INTEGER NOT NULL,
    htpi_id                    INTEGER NOT NULL,
    osih_dtinstalacao          TIMESTAMP WITH LOCAL TIME ZONE,
    osih_ictipoprotecao        VARCHAR2(1),
    osih_ictrocaprotecao       SMALLINT,
    osih_ictrocaregistro       SMALLINT,
    osih_nnleiturainstalacao   INTEGER,
    osih_nnselo                VARCHAR2(20),
    osih_iccavalete            VARCHAR2(1)
)
LOGGING;
...
CREATE TABLE mos_ordem_servico_religacao (
    ...
    orse_id                   INTEGER NOT NULL,
    osre_dtreligacao          TIMESTAMP WITH LOCAL TIME ZONE,
    osre_tmreligacao          VARCHAR2(10),
    osre_nnhidrometro         VARCHAR2(20),
    osre_dtinstalacao         TIMESTAMP WITH LOCAL TIME ZONE,
    osre_nneiturainstalacao   INTEGER,
    osre_nnselo               VARCHAR2(20),
    osre_iccavelete           VARCHAR2(1),
...
CREATE TABLE mos_ordem_servico_subshm (
    ...
    orse_id                    INTEGER NOT NULL,
    ossh_nnhidrometroatual     VARCHAR2(20),
    ossh_ictipomedicaoatual    SMALLINT,
    ossh_dtretirada            TIMESTAMP WITH LOCAL TIME ZONE,
    ossh_nnleituraretirada     INTEGER,
    hdst_id                    INTEGER NOT NULL,
    hdla_id                    INTEGER NOT NULL,
    ossh_nnhidrometronovo      VARCHAR2(20),
    ossh_dtinstalacao          TIMESTAMP WITH LOCAL TIME ZONE,
    ...
    ossh_nnselo                VARCHAR2(20),
    ossh_iccavalete            VARCHAR2(1),
    hits_id                    INTEGER NOT NULL,
    ossh_tminstalacao          VARCHAR2(10)
)
LOGGING;
...
CREATE TABLE mos_pavimento_tipo (
    pavt_id                INTEGER NOT NULL,
    empr_id                INTEGER NOT NULL,
    pavt_dspavimentotipo   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_religacao_tipo (
    retp_id                INTEGER NOT NULL,
    empr_id                INTEGER NOT NULL,
    rept_dsreligacaotipo   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_servico_tipo (
    svtp_id              INTEGER NOT NULL,
    svtp_dsservicotipo   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_servico_tipo_especificacao (
    ...
    svtp_id                  INTEGER NOT NULL,
    step_dssolicitacaotipo   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_veiculo (
    ...
    empr_id                 INTEGER NOT NULL,
    veic_nnplaca            VARCHAR2(20),
    veic_nnkmacumulada      FLOAT,
    veic_dtultimarevisao    TIMESTAMP WITH LOCAL TIME ZONE,
    veic_dtproximarevisao   TIMESTAMP WITH LOCAL TIME ZONE
)
LOGGING;
...
CREATE TABLE mos_veiculo_marca (
    vemr_id               INTEGER NOT NULL,
    empr_id               INTEGER NOT NULL,
    vemr_dsveiculomarca   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_veiculo_modelo (
    vemo_id                INTEGER NOT NULL,
    empr_id                INTEGER NOT NULL,
    vemo_dsveiculomodelo   VARCHAR2(60)
)
LOGGING;
...
CREATE TABLE mos_veiculo_tipo (
    vetp_id              INTEGER NOT NULL,
    empr_id              INTEGER NOT NULL,
    vetp_dsveiculotipo   VARCHAR2(60)
)
LOGGING;
